...
$target_file = "images/".basename($FILES['event_image']['tmp_name']);

if(move_uploaded_file($_FILES['event_image']['tmp_name'], $target_file)){
  echo "cover uploaded ";
  $sql_event = "INSERT INTO event (information_id, information_title, information_content, information_image) VALUES (1,'$event_title', '$event_contain', '$event_image')";
  $db->query($sql_event);
  header('Location:admin.php');

}else{
  $sql_event = "INSERT INTO event (information_id, information_title, information_content, information_image) VALUES (1,'$event_title', '$event_contain', 'avatar.jpg')";
  $db->query($sql_event);
}
    // if(isset($_FILES['event_image']['tmp_name'])){
    //   $event_image = $_FILES['event_image']['tmp_name'];
    //   // $target = "images/".basename($_FILES['event_image']['tmp_name']);
    //   move_uploaded_file($_FILES['event_image']['tmp_name'], "images/");
    //   $sql_event = "INSERT INTO event (information_id, information_title, information_content, information_image) VALUES (1,'$event_title', '$event_contain', '$event_image')";
    //   $db->query($sql_event);
    // }
}
